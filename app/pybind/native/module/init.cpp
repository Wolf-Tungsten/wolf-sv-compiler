...
static PyMethodDef WolvrixMethods[] = {
    ...
    {"session_lower_grhsim", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_lower_grhsim), METH_VARARGS | METH_KEYWORDS,
     "session_lower_grhsim(session, design, module, top=None, replace=False) -> (success, diagnostics)"},
    {"session_read_grhsim_json_file", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_read_grhsim_json_file), METH_VARARGS | METH_KEYWORDS,
     "session_read_grhsim_json_file(session, path, module, replace=False) -> (success, diagnostics)"},
    {"session_load_grhsim_json_text", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_load_grhsim_json_text), METH_VARARGS | METH_KEYWORDS,
     "session_load_grhsim_json_text(session, text, module, replace=False) -> (success, diagnostics)"},
    {"session_grhsim_json_text", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_grhsim_json_text), METH_VARARGS | METH_KEYWORDS,
     "session_grhsim_json_text(session, module, pretty=True) -> str"},
    {"session_store_grhsim_json", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_store_grhsim_json), METH_VARARGS | METH_KEYWORDS,
     "session_store_grhsim_json(session, module, output, pretty=True) -> (success, diagnostics)"},
    {"session_run_sim_pass", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_run_sim_pass), METH_VARARGS | METH_KEYWORDS,
     "session_run_sim_pass(session, name, module, args=None, dryrun=False, log_level='warn') -> (success, changed, diagnostics)"},
    {"session_emit_grhsim", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_session_emit_grhsim), METH_VARARGS | METH_KEYWORDS,
     "session_emit_grhsim(session, module, backend, output, ops_per_source_file=50000, fixed_point_iteration_limit=100) -> (success, diagnostics)"},
    ...
    {"list_sim_passes", reinterpret_cast<PyCFunction>(wolvrix::app::pybind::py_list_sim_passes), METH_NOARGS,
     "list_sim_passes() -> list[str]"},
