...
static PyMethodDef WolvrixMethods[] = {
    ...
    {"session_emit_grhsim_cpp",
     ...
     "session_emit_grhsim_cpp(session, design, output, top=None, max_cpp_file_bytes=None, waveform=None, perf=None, input_fullpass_specialization=False) -> (success, diagnostics)"},
