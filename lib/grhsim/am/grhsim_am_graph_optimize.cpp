...
namespace wolvrix::lib::grhsim::am {
    ...
    namespace {
        ...
        // Constant word helpers and the pure-op constant evaluator moved to
        // grhsim_am_const_eval.hpp (shared with the GRH -> AM lowering).
        using detail::ConstOperand;
        using detail::evaluatePure;
        using detail::getBit;
        using detail::normalizeWords;
        using detail::setBit;
        using detail::truth;
        using detail::wordCount;
